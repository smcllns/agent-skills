...
Compares how Haiku, Sonnet, and Opus handle the md-asks skill on a single fixture of 9 graded test cases. Lets us pick a recommended default model for scheduled runs.
...
- **Haiku 4.5** — strongest risk at L4 (oblique reference, requires distant edit) and L5 (resisting the temptation to guess on ambiguous ask). May over-edit on L9 (write a body change instead of just answering in the callout).
