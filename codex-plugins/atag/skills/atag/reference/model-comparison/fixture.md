# Markdown Agent Tags model comparison fixture

This file contains 9 graded test cases at increasing difficulty. Run the `atag` skill on a copy of this file with a given model; the result file is graded against the rubric in `README.md`.
...
## L2 — mid-prose edit referenced by tag
...
A passage of writing precedes this tag. The writing is fine but could be many things — funnier, shorter, longer, more formal, more casual, more concrete, more abstract.
...
An email address: contact@claude.com — this is part of an email, not a tag.
